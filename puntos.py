    ...
    with open(ruta_archivo) as archivo:  # Abrimos el archivo
        for linea in archivo.readlines():
            ...
            if len(linea_separada) == 4:  
                ...
                # Validamos los tipos
                if type(codigo) == str and type(nombre) == str and \
                    type(coordenada_x) == float and type(coordenada_y) == float:
...
def filtrar_puntos(puntos, origen, distancia):
    ...
    for punto in puntos:
        ...
        if distancia_x > origen[0] and distancia_x < (distancia_x + distancia) \
            and distancia_y > origen[1] and distancia_y < (distancia_y + distancia):
